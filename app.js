...
(function initDummyDB(){
  ...
  /* Dummy Barang (10 item) */
  if (!localStorage.getItem("barang")) {
    saveLocal("barang", [
      {
        id:1,
        kode_barang:"BM001",
        nama:"Oli Pertamina Enduro 1L",
        harga_modal:28000,
        harga:45000,
        stock:12,
        kategori:"Oli",
        foto:"https://i.imgur.com/9rV0oKl.jpeg",
        deskripsi:"",
      ...
      },
      {
        ...
        stock:8,
        kategori:"Sparepart",
        foto:"https://i.imgur.com/7iH5Pf7.jpeg",
        deskripsi:"",
        created_at:new Date().toISOString()
      },
      {
        ...
        stock:15,
        kategori:"Sparepart",
        foto:"https://i.imgur.com/NmJ32nP.jpeg",
        deskripsi:"",
        created_at:new Date().toISOString()
      },
      {
        ...
        stock:3,
        kategori:"Aki",
        foto:"https://i.imgur.com/YLtV2sQ.jpeg",
        deskripsi:"",
        created_at:new Date().toISOString()
      },
      {
        id:5,
        kode_barang:"BM005",
        nama:"Ban Luar FDR 80/90",
        harga_modal:135000,
        harga:175000,
        stock:5,
        kategori:"Ban",
        foto:"https://i.imgur.com/jxNn1Dl.jpeg",
        deskripsi:"",
        created_at:new Date().toISOString()
      },
      {
        ...
        stock:9,
        kategori:"Ban",
        foto:"https://i.imgur.com/te0VVoE.jpeg",
        deskripsi:"",
        created_at:new Date().toISOString()
      },
      {
        ...
        stock:6,
        kategori:"Sparepart",
        foto:"https://i.imgur.com/YCIzX7P.jpeg",
        deskripsi:"",
        created_at:new Date().toISOString()
      },
      {
        ...
        stock:10,
        kategori:"Lampu",
        foto:"https://i.imgur.com/HU1A3Tw.jpeg",
        deskripsi:"",
        created_at:new Date().toISOString()
      },
      {
        ...
        stock:4,
        kategori:"Suspensi",
        foto:"https://i.imgur.com/vd3pVuM.jpeg",
        deskripsi:"",
        created_at:new Date().toISOString()
      },
      {
        ...
        stock:7,
        kategori:"Sparepart",
        foto:"https://i.imgur.com/2jAkI7J.jpeg",
        deskripsi:"",
        created_at:new Date().toISOString()
      }
    ]);
